...
const useSynthesizedSound = (isMuted) => {
  ...
  const playSound = (type) => {
    ...
    switch (type) {
      case 'type-key': // Typewriter sound
      ...
      case 'page-turn': // Button click / Page turn
      ...
      case 'dice-roll': // Dice rolling sound
        for (let i = 0; i < 6; i++) {
          ...
          gainDice.gain.exponentialRampToValueAtTime(
            0.01,
            t + timeOffset + 0.04
          );
...
const SvgIllustrations = {
  Title: () => (
    ...
    >
      ...
      <g filter="url(#ink)" stroke="#0a0a0a" strokeWidth="2" fill="none">
        <path
          d="M50 250 L50 150 L100 100 L150 150 L150 250 M100 100 L100 50 L120 50 M250 250 L250 120 L300 80 L350 120 L350 250"
          fill="#2a2a2a"
          opacity="0.1"
        />
        ...
        <path
          d="M0 280 Q 50 260 100 280 T 200 280 T 300 280 T 400 280"
          strokeWidth="1"
          opacity="0.5"
        />
      </g>
  ...
  Tarot: () => (
    ...
    >
      <g stroke="#0a0a0a" strokeWidth="2" fill="none">
        ...
        />
        <path
          d="M70 90 L130 190 M130 90 L70 190"
          strokeWidth="0.5"
          transform="rotate(-10 100 140)"
        />
        ...
        <rect
          ...
          height="120"
          rx="2"
          transform="rotate(10 300 140)"
          fill="white"
        />
        <path
          d="M270 90 L330 90 L300 190 Z"
          strokeWidth="0.5"
          transform="rotate(10 300 140)"
        />
      </g>
  ...
  Numerology: () => (
    ...
    >
      <g stroke="#0a0a0a" strokeWidth="2" fill="none">
        ...
        <text x="190" y="90" fontSize="20" fill="#0a0a0a" fontFamily="serif">
          XII
        </text>
        <text x="260" y="160" fontSize="20" fill="#0a0a0a" fontFamily="serif">
          III
        </text>
        <text x="190" y="220" fontSize="20" fill="#0a0a0a" fontFamily="serif">
          VI
        </text>
        <text x="130" y="160" fontSize="20" fill="#0a0a0a" fontFamily="serif">
          IX
        </text>
  ...
  Runes: () => (
    ...
    >
      <g stroke="#0a0a0a" strokeWidth="2" fill="none">
        <path
          d="M100 200 Q 120 150 160 160 Q 190 180 180 220 Q 150 250 100 200"
          fill="white"
        />
        <path
          d="M220 200 Q 240 140 280 150 Q 310 170 300 230 Q 260 260 220 200"
          fill="white"
        />
        <path
          d="M150 120 Q 180 80 220 90 Q 250 110 240 150 Q 200 180 150 120"
          fill="white"
        />
        <path
          d="M130 180 L130 220 M130 190 L150 180 M130 200 L150 190"
          strokeWidth="2"
        />
        <path
          d="M250 180 L250 220 M250 180 L270 200 L250 220"
          strokeWidth="2"
        />
        <path
          d="M190 110 L190 150 M190 110 L210 130 M210 130 L190 150"
          strokeWidth="2"
        />
      </g>
    </svg>
...
const App = () => {
  ...
  const goToFloor = (floor) => {
    ...
    if (floor === 'numerology') {
      ...
      typeText(
        scenes.numerology.text +
          `\n\n……歯車が止まり、数字の『${lp}』が示された。`
      );
    } else if (floor === 'astrology') {
      const zodiac = getZodiacSign(birthDate);
      typeText(
        scenes.astrology.text +
  ...
  const resolveTarot = (cardIndex) => {
    ...
    const cards = [
      {
        name: '愚者 (The Fool)',
        meaning: '新たな始まり、自由、無邪気。恐れずに進め。',
        luck: 1,
      },
      {
        name: '運命の輪 (Wheel)',
        meaning: 'チャンス、変化、運命の転換点。流れに身を任せよ。',
        luck: 3,
      },
      {
        name: '塔 (The Tower)',
        meaning: '予期せぬ変化、崩壊、啓示。衝撃に備えよ。',
        luck: -3,
      },
      {
        name: '星 (The Star)',
        meaning: '希望、インスピレーション、静寂。願いは叶うだろう。',
        luck: 2,
      },
      {
        name: '死神 (Death)',
        meaning: '終わりと始まり、変容。過去を捨て去る時。',
        luck: 0,
      },
      {
        name: '世界 (The World)',
        meaning: '完成、達成、旅の終わり。素晴らしい成功。',
        luck: 4,
      },
    ];
  ...
  const resolveAstrology = () => {
    ...
    const results = {
      fire: {
        text: `「${zodiac.name}」は炎の属性を持つ。\n炎の精霊が囁く。「情熱のままに行動せよ。だが、焼き尽くさぬよう注意せよ」`,
        luck: 1,
      },
      earth: {
        text: `「${zodiac.name}」は地の属性を持つ。\n地の精霊が囁く。「足元を固めよ。忍耐こそが黄金を生む」`,
        luck: 1,
      },
      air: {
        text: `「${zodiac.name}」は風の属性を持つ。\n風の精霊が囁く。「知恵と情報を集めよ。今は動く時ではないかもしれない」`,
        luck: 0,
      },
      water: {
        text: `「${zodiac.name}」は水の属性を持つ。\n水の精霊が囁く。「流れに身を委ねよ。直感こそが最大の武器となる」`,
        luck: 2,
      },
    };
  ...
  const resolveRune = () => {
    ...
    const runes = [
      {
        name: 'フェフ (Fehu)',
        desc: '「富」を象徴する。物質的な豊かさが訪れる予兆。',
        luck: 3,
      },
      {
        name: 'ウルズ (Uruz)',
        desc: '「野牛」を象徴する。強靭な生命力と変化の時。',
        luck: 2,
      },
      {
        name: 'スリサズ (Thurisaz)',
        desc: '「巨人」を象徴する。試練や警告。慎重になれ。',
        luck: -2,
      },
      {
        name: 'アンズース (Ansuz)',
        desc: '「神」を象徴する。知恵や良い知らせが届く。',
        luck: 2,
      },
    ];
  ...
  const resolveNumerology = () => {
    ...
    switch (num) {
      case 1:
        msg =
          '「1」は『開拓者』の数字。リーダーシップと独立心を発揮する時だ。新しい道を切り開け。';
        break;
      case 2:
        msg =
          '「2」は『調和』の数字。協力と感受性が鍵となる。焦らず、周囲とのバランスを大切にせよ。';
        break;
      case 3:
        msg =
          '「3」は『創造』の数字。表現力と喜びが溢れている。子供のような遊び心を忘れるな。';
        break;
      case 4:
        msg =
          '「4」は『建設』の数字。地道な努力と秩序が成果を生む。基礎を固めるのに最適な時期だ。';
        break;
      case 5:
        msg =
          '「5」は『変化』の数字。冒険と自由を求めよ。予想外の展開を楽しむ余裕を持つことだ。';
        break;
      case 6:
        msg =
          '「6」は『調和』の数字。責任と愛情がテーマだ。身近な人々を大切にすることで運が開ける。';
        break;
      case 7:
        msg =
          '「7」は『探求』の数字。内面を見つめ、真理を探せ。孤独を恐れず、知恵を深めるのだ。';
        break;
      case 8:
        msg =
          '「8」は『豊かさ』の数字。権力と成功を掴むエネルギーがある。自信を持って目標に挑め。';
        break;
      case 9:
        msg =
          '「9」は『完結』の数字。手放し、次のステージへ進む準備をせよ。慈悲の心が幸運を呼ぶ。';
        break;
      case 11:
        msg =
          '「11」は『天啓』の数字。鋭い直感が働いている。論理よりも感覚を信じて進め。';
        break;
      case 22:
        msg =
          '「22」は『大願成就』の数字。大きな夢を現実に変える力がある。スケールの大きな行動を。';
        break;
      case 33:
        msg =
          '「33」は『愛の奉仕』の数字。普遍的な愛を体現せよ。損得勘定を捨てた時、奇跡が起きる。';
        break;
      default:
        msg = `「${num}」……それが今の君を導く数字だ。`;
        break;
    }
  ...
  const showResult = () => {
    ...
    if (playerStats.luck >= 16) {
      verdict =
        '信じられない……！君の運気は「伝説級」だ。デパートの創設者も驚くほどの強運の持ち主だ。このまま宝くじ売り場へ直行することをお勧めする。';
    } else if (playerStats.luck >= 12) {
      verdict =
        '素晴らしい。君の運気は「絶好調」にある。迷わず進めば、大抵の扉は開かれるだろう。';
    } else if (playerStats.luck >= 8) {
      verdict =
        '悪くない。君の運気は「安定」している。派手さはないが、着実な成果を得られる日だ。';
    } else {
      verdict =
        'ふむ……君の運気には少し「陰り」が見える。だが、このデパートで厄は落とされた。帰りに温かいココアでも飲んでリラックスすれば、運気は回復するだろう。';
    }
  ...
  const CurrentIllustration =
    scenes[gameState]?.Illustration || SvgIllustrations.Title;
  ...
  const Dice3D = ({ val }) => (
    <div className="w-16 h-16 bg-[#fffff0] border-2 border-[#0a0a0a] rounded-lg flex items-center justify-center shadow-lg transform rotate-12 transition-all duration-500">
      <span className="text-3xl font-bold font-serif text-[#0a0a0a]">
        {val}
      </span>
    </div>
  );
  ...
  return (
    ...
    >
      ...
      {/* Main Container */}
      <div className="relative z-10 max-w-md mx-auto min-h-screen flex flex-col border-x-4 border-double border-[#0a0a0a] bg-[#f0e6d2] shadow-2xl">
        {/* Header */}
        <div className="bg-[#0a0a0a] text-[#f0e6d2] p-2 border-b-4 border-double border-[#0a0a0a] flex justify-between items-center sticky top-0 z-30 shadow-md">
          ...
          <div className="flex gap-4 text-sm font-bold font-mono items-center">
            <div className="flex items-center gap-1">
              <Star size={14} /> LUCK: {playerStats.luck}
            </div>
        ...
        <div className="relative w-full h-64 overflow-hidden border-b-4 border-black bg-[#e3dac9] group flex items-center justify-center paper-texture">
        ...
        {/* Text Area */}
        <div className="flex-grow p-4 sm:p-6 flex flex-col relative">
          <div className="absolute top-2 left-2 w-4 h-4 border-t-2 border-l-2 border-[#0a0a0a] opacity-60"></div>
          <div className="absolute top-2 right-2 w-4 h-4 border-t-2 border-r-2 border-[#0a0a0a] opacity-60"></div>
          <div className="absolute bottom-2 left-2 w-4 h-4 border-b-2 border-l-2 border-[#0a0a0a] opacity-60"></div>
          <div className="absolute bottom-2 right-2 w-4 h-4 border-b-2 border-r-2 border-[#0a0a0a] opacity-60"></div>

          <div className="prose prose-p:text-[#0a0a0a] prose-lg leading-relaxed font-medium">
            {gameState === 'title' ? (
              <div className="text-center py-8 animate-fade-in">
                <h1 className="font-display text-5xl mb-4 text-[#0a0a0a] drop-shadow-sm leading-tight">
                  運命の
                  <br />
                  迷宮デパート
                </h1>
                <p className="text-sm italic font-semibold text-[#0a0a0a] opacity-90 mb-8">
                  - THE DEPARTMENT STORE OF DESTINY -
                </p>
                <div className="w-16 h-1 bg-[#0a0a0a] mx-auto mb-8"></div>
                <div className="flex items-center justify-center gap-2 mb-4 text-base text-[#0a0a0a] font-bold opacity-80">
                  <BookOpen size={16} /> <span>ようこそ、彷徨える魂よ。</span>
                </div>
              </div>
            ) : (
              <p className="whitespace-pre-wrap min-h-[120px] drop-shadow-sm text-[#0a0a0a] font-semibold">
                {text}
            ...
            {gameState === 'intro' && !isTyping && (
              <div className="mt-4 animate-fade-in-up w-full">
                <label className="block text-sm font-bold text-[#0a0a0a] mb-2 font-display">
                  BIRTH DATE (魂の刻印)
                </label>
                <div className="relative">
                  <input
                    ...
                    className="w-full max-w-full p-3 bg-[#fffff0] border-2 border-[#0a0a0a] text-[#0a0a0a] font-mono text-lg text-center shadow-inner outline-none focus:ring-2 focus:ring-[#0a0a0a] rounded-sm appearance-none box-border"
            ...
            {gameState === 'tarot' && tarotResult && (
              <div className="mt-6 p-4 border-2 border-[#0a0a0a] bg-white bg-opacity-60 text-center animate-fade-in-up shadow-inner">
                ...
                <h3 className="font-bold text-xl mt-2 border-b-2 border-[#0a0a0a] text-[#0a0a0a] inline-block pb-1">
                  {tarotResult.name}
                </h3>
              </div>
            )}
        ...
        {/* Buttons / Interaction Area */}
        <div className="p-4 bg-[#0a0a0a] bg-opacity-5 backdrop-blur-sm border-t-4 border-double border-[#0a0a0a]">
          <div className="flex flex-col gap-3">
            ...
            {gameState === 'floor_select' && !isTyping && (
              <div className="grid grid-cols-1 gap-2">
                {!visitedFloors.includes('tarot') && (
                  <button
                    onClick={() => handleAction(() => goToFloor('tarot'))}
                    className={btnClass}
                  >
                ...
                {!visitedFloors.includes('numerology') && (
                  <button
                    onClick={() => handleAction(() => goToFloor('numerology'))}
                    className={btnClass}
                  >
                ...
                {!visitedFloors.includes('runes') && (
                  <button
                    onClick={() => handleAction(() => goToFloor('runes'))}
                    className={btnClass}
                  >
                ...
                {!visitedFloors.includes('dice') && (
                  <button
                    onClick={() => handleAction(() => goToFloor('dice'))}
                    className={btnClass}
                  >
                ...
                {!visitedFloors.includes('astrology') && (
                  <button
                    onClick={() => handleAction(() => goToFloor('astrology'))}
                    className={btnClass}
                  >
                ...
                {/* Go to Result if enough floors visited */}
                {visitedFloors.length >= 3 && (
                  <button
                    onClick={() => handleAction(showResult)}
                    className={`${btnClass} bg-red-900 text-white hover:bg-red-800 border-[#0a0a0a] mt-2`}
                  >
            ...
            {gameState === 'tarot' && !tarotResult && !isTyping && (
              <div className="grid grid-cols-3 gap-2">
                {[1, 2, 3].map((i) => (
                  <button
                    key={i}
                    onClick={() => handleAction(() => resolveTarot(i))}
                    className="h-32 bg-[#0a0a0a] text-[#f0e6d2] rounded border-2 border-[#f0e6d2] hover:-translate-y-2 transition-transform flex items-center justify-center shadow-lg active:scale-95"
                  >
                    <span className="font-display text-4xl opacity-80">?</span>
                  </button>
                ))}
              </div>
            )}

            {/* Astrology (Auto Resolved based on Birthday) */}
            {gameState === 'astrology' && !astroResult && !isTyping && (
              <div className="flex flex-col gap-2">
                <div className="p-4 bg-[#fffff0] border-2 border-[#0a0a0a] text-[#0a0a0a] text-center mb-2 shadow-md rounded-sm">
                  <span className="font-bold text-lg">鑑定中...</span>
                </div>
                <button
                  onClick={() => handleAction(resolveAstrology)}
                  className={btnClass}
                >
                  星の声を聞く
                </button>
            ...
            {gameState === 'runes' && !runeResult && !isTyping && (
              <button
                onClick={() => handleAction(resolveRune)}
                className={btnClass}
              >
                袋の中に手を入れる
              </button>
            ...
            {/* Numerology (Auto Resolved based on Birthday) */}
            {gameState === 'numerology' && !numResult && !isTyping && (
              <button
                onClick={() => handleAction(resolveNumerology)}
                className={btnClass}
              >
                運命数を受け入れる
              </button>
            ...
            {gameState === 'dice' && !diceResult && !isTyping && (
              <button
                onClick={() => {
                  if (!isTyping) resolveDice();
                }}
                className={`${btnClass} bg-red-900 text-white hover:bg-red-800 border-[#0a0a0a]`}
              >
                <Dices size={18} /> サイコロを振る！
              </button>
            )}

            {/* Back to Floor Select (Common for all sub-games) */}
            {['tarot', 'dice', 'astrology', 'numerology', 'runes'].includes(
              gameState
            ) &&
              (tarotResult ||
                diceResult ||
              ...
              !isTyping && (
                <button
                  onClick={() => handleAction(proceedToFloorSelect)}
                  className={btnClass}
                >
            ...
            {isTyping && (
              <div className="text-center text-sm text-[#0a0a0a] opacity-80 animate-pulse font-mono py-3 font-bold">
                ... 記述中 ...
              </div>
            )}
          </div>
